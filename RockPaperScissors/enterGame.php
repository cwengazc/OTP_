...
<body class="full-height-grow">
	...
	<section class="join-main-section"> 
		...
		<div href="/" class="left-join-section" >
			<h1 class="join-text"> 
				Waiting for other online players.. <br> 
			</h1>
		
			<img src="multiplayer-sign.png" alt="Waiting for player">
		</div>
...
<?php 
header("Refresh: 5;url=http://10.100.15.216/RockPaperScissors/loading.php");
?>
