...
class Checker {
    ...
    constructor(element, position, board) {
        ...
        if (this.element.getAttribute('id') < 20) {         // so that everything matches based on where you placed the player's pieces
            this.player = 1;
        } else {
            this.player = 2;
        }
    ...
    */
    ...
    Move(tile) {
        function getChecker() {
            ...
            xhr.open('GET', 'processSome.php?start='+0, true);
        ...
        // To be sure that checker can't go backwards if it's not a king        // important for checker positioning
        ...
        if (!this.king && (this.position[0] === 0 || this.position[0] === this.board.boardSize - 1)) {
            ...
            Logger.Log((this.player == 1 ? player1 : player2) + ': ' + DrawManger.GetTileName(this.position[0], this.position[1]) +
                        ' became king');
        }
    ...
    */
    ...
    Attack(tile) {
        ...
        if (checkerToRemove) {
            ...
            function getChecker() {
                ...
                xhr.open('GET', 'processSome.php?attack='+1, true);
    ...
    Remove(checker) {
        ...
        Logger.Log((this.player == 1 ? player1 : player2) + ': ' + DrawManger.GetTileName(this.position[0], this.position[1]) + ' attacked ' +
